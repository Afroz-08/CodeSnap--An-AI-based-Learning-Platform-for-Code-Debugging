...
export default function FileExplorer() {
  ...
  const renderFile = (file) => {
    ...
    return (
      ...
      >
        <span className="mr-2 text-sm">{getFileIcon(file.language)}</span>
      ...
      <div className="p-3 border-b border-gray-700">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full px-3 py-2 bg-green-600 hover:bg-green-700 text-white text-xs font-medium rounded flex items-center justify-center transition-colors"
          ...
          <button
            ...
            className="w-full px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium rounded flex items-center justify-center transition-colors"
          ...
          <button
            ...
            className="w-full px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white text-xs font-medium rounded flex items-center justify-center transition-colors"
